...
<div class="modal-subtitle">Saves to Supabase and syncs to the app.</div>
</div>
<button class="btn btn-ghost" onclick="closeModal('modal-event')">
...
<input type="text" id="f-new-city" placeholder="New city…" style="display:none;margin-top:6px" class="form-input">
</div>
</div>
<div class="form-row single">
<div class="field">
<label>Street Address</label>
<input type="text" id="f-addr" placeholder="601 N Main St">
</div>
</div>
<div class="form-row single">
<div class="field">
<label>Description</label>
<textarea id="f-desc" rows="3" placeholder="Description…" style="resize:vertical"></textarea>
</div>
</div>
</div>
<div class="form-section">
...
<span class="field-hint">Optional — for multi-day events.</span>
</div>
</div>
<div class="form-row">
<div class="field">
...
<div class="form-section">
<div class="form-section-title">Coordinates
<span class="optional-tag">Optional</span>
</div>
<div class="form-row">
<div class="field">
<label>Latitude</label>
<input type="text" class="mono" id="f-lat" placeholder="30.2672">
<span class="field-hint">N positive</span>
</div>
<div class="field">
<label>Longitude</label>
<input type="text" class="mono" id="f-lng" placeholder="-88.8220">
...
<div class="field">
<label>Website</label>
<input type="url" id="f-website" placeholder="https://example.com">
</div>
</div>
</div>
<div class="form-section">
...
<div class="img-drop-title">Drop or click to browse</div>
<div class="img-drop-sub">JPG, PNG, WebP · 10MB</div>
</div>
<div id="profile-preview" style="display:none"></div>
</div>
<div id="profile-url-panel" style="display:none">
<div class="field">
<input type="url" id="f-profile-url" placeholder="https://example.com/image.jpg">
...
<input type="url" id="f-speechify" placeholder="https://speechify.com/share/…">
...
<button class="btn btn-primary" id="btn-save-event" onclick="saveEvent()">
Save Event
</button>
</div>
</div>
...
<div class="modal-subtitle">Bulk-add from CSV.</div>
</div>
...
<div class="modal-body">
<div id="imp-upload">
<div class="import-zone" id="imp-drop">
<input type="file" id="imp-file" accept=".csv" onchange="handleImportFile(this.files[0])">
<svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"/></svg>
<div class="import-zone-title">Drop CSV or click to browse</div>
<div class="import-zone-sub">Max 500</div>
</div>
...
<span class="csv-col">end_date</span>
<span class="csv-col">start_time</span>
<span class="csv-col">end_time</span>
...
<span class="csv-col">speechify_link</span>
<span class="csv-col">latitude</span>
<span class="csv-col">longitude</span>
</div>
<div style="margin-top:10px;font-size:11.5px;color:var(--gray-400);display:flex;flex-direction:column;gap:3px">
<span>Date format: <span style="font-family:'DM Mono',monospace">YYYY-MM-DD</span></span>
<span>Time format: <span style="font-family:'DM Mono',monospace">HH:MM</span> (24hr)</span>
<span>City must match exactly: <span style="font-family:'DM Mono',monospace" id="city-hint">—</span></span>
</div>
</div>
</div>
...
<svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" style="width:13px;height:13px"><path d="M10 19l-7-7m0 0l7-7m-7 7h18"/></svg>
Back
</button>
<button class="btn btn-secondary" onclick="closeModal('modal-import')">Cancel</button>
<button class="btn btn-primary" id="btn-imp-ok" style="display:none" onclick="confirmImport()">
...
<span id="btn-imp-lbl">Import</span>
</button>
</div>
</div>
</div>
